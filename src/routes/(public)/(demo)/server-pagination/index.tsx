...
export const Route = createFileRoute('/(public)/(demo)/server-pagination/')({
...
function PageServerPagination() {
      ...
      <div className='mb-6 flex flex-wrap justify-center gap-2'>
        ...
        <Button
          ...
          onClick={async () => {
            ...
            router.invalidate({
              filter: (route) =>
                route.routeId === '/(public)/(demo)/server-pagination/'
            })
  ...
  const renderPosts = () => {
    ...
    return (
      <pre className='bg-card mx-auto mb-6 max-w-250 overflow-scroll rounded-lg border p-4 text-sm shadow'>
