...
export const FullPageImageDemo = () => {
  ...
  return (
    <Fragment>
      <BackgroundImage
        ...
        className={`group relative flex h-screen w-full shrink-0 items-center justify-center overflow-auto bg-white/0 p-4 bg-blend-overlay transition-colors duration-700 hover:bg-white/60`}
      >
  ...
  <BackgroundImage
    src={person}
    className='relative flex h-screen w-full shrink-0 items-center justify-center overflow-auto bg-white/50 p-4 bg-blend-overlay transition-colors duration-700 hover:bg-white/80'
  >...</BackgroundImage>
        `}</code>
          </pre>
