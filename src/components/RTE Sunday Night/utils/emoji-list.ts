...
// - NOT from the Lexical playground source code
// Lexical also gets its list from the same place, but this version is newer/larger.
// https://github.com/facebook/lexical/blob/main/packages/lexical-playground/src/utils/emoji-list.ts
