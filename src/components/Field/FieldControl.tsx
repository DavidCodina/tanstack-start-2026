...
const fieldControlVariants = cva(baseClasses, {
  variants: {
    fieldSize: {
...
// This version is still styled to be used as an Input, but prefer the actual Input.
  ...
  return (
    <Field.Control
      ...
      className={(fieldRootState) => {
        ...
        return cn(fieldControlVariants({ fieldSize }), className)
      }}
      style={style}
      render={render}
    />
