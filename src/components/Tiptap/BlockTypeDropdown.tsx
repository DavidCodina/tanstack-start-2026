...
//         className={cn(
//           buttonClasses,
//           editorState?.isParagraph && SELECTED_MIXIN
//         )}
//         onClick={() => editor.chain().focus().setParagraph().run()}
//         title='Paragraph'
//         type='button'
...
//         className={cn(
//           buttonClasses,
//           editorState?.isHeading1 && SELECTED_MIXIN
//         )}
//         onClick={() =>
...
//         className={cn(
//           buttonClasses,
//           editorState?.isHeading2 && SELECTED_MIXIN
//         )}
//         onClick={() =>
...
//         className={cn(
//           buttonClasses,
//           editorState?.isHeading3 && SELECTED_MIXIN
//         )}
//         onClick={() =>
...
//         className={cn(
//           buttonClasses,
//           editorState?.isHeading4 && SELECTED_MIXIN
//         )}
//         onClick={() =>
...
//         className={cn(
//           buttonClasses,
//           editorState?.isHeading5 && SELECTED_MIXIN
//         )}
//         onClick={() =>
...
//         className={cn(
//           buttonClasses,
//           editorState?.isHeading6 && SELECTED_MIXIN
//         )}
//         onClick={() =>
...
//         className={cn(
//           buttonClasses,
//           editorState?.isBulletList && SELECTED_MIXIN
//         )}
//         onClick={() => editor.chain().focus().toggleBulletList().run()}
//         title='Bullet List'
//         type='button'
...
//         className={cn(
//           buttonClasses,
//           editorState?.isOrderedList && SELECTED_MIXIN
//         )}
//         onClick={() => editor.chain().focus().toggleOrderedList().run()}
//         title='Ordered List'
//         type='button'
...
//         className={cn(
//           buttonClasses,
//           editorState?.isBlockquote && SELECTED_MIXIN
//         )}
//         onClick={() => editor.chain().focus().toggleBlockquote().run()}
//         title='quote'
//         type='button'
...
//         className={cn(
//           buttonClasses,
//           editorState?.isCodeBlock && SELECTED_MIXIN
//         )}
//         onClick={() => editor.chain().focus().toggleCodeBlock().run()}
//         title='Code Block'
//         type='button'
