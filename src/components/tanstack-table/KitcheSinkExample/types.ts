...
export interface ITable {
  ...
  tableSize?: 'sm' | 'small' | 'xs' | 'extra-small'
  ...
  columns: ColumnDef<unknown, any>[] | null // Previously was: Record<string, any>[] | null
  columnOrder?: ColumnOrderState // Prevous was: string[]
  columnVisibility?: VisibilityState // Previously was: Record<string, boolean>
