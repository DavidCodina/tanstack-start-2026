...
export const columns = [
  ...
  columnHelper.accessor('last_name', {
    ...
    footer: (info) => info.column.id,
    enableColumnFilter: true // Custom property
  }),
  ...
  columnHelper.accessor('age', {
    ...
    //
    ///////////////////////////////////////////////////////////////////////////
    sortDescFirst: false, // The first sort order will be ascending (nullable values can mess up auto detection of sort order)
    enableColumnFilter: true, // Custom property
